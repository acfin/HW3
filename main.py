...
def update_basket_a():
    ...
    return render_template('update_basket_a.html', output=log)
...
def unique():
    ...
    record = util.run_and_fetch_sql(cursor, "select * from basket_a FULL JOIN basket_b ON fruit_a=fruit_b WHERE fruit_a is NULL OR fruit_b IS NULL")
